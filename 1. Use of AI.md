...
While this is an example of Giovanni Victorio's work on the Cannabinoid Receptor Type 1, many aspects after the RFdiffusion step were changed to avoid revealing intellectual property.

| Tool | Input | Input Example | Output | Output Example |
|------|-------|--------|--------|--------|
| [**RFdiffusion**](https://github.com/RosettaCommons/RFdiffusion) | G Protein-Coupled Receptor (Cannabinoid Receptor Type 1 3D Structure) | <img width="500" height="500" alt="image" src="https://github.com/user-attachments/assets/94086785-a47b-49f3-b904-81ad94000ae1" /> | Generated Peptide Backbone to Agonize or Antagonize (Peptide 3D Structure) | <img width="483" height="497" alt="CB1 Peptide" src="https://github.com/user-attachments/assets/e0d1d308-bd18-4364-b428-fd07777b73c6" /> |
| [**LigandMPNN**](https://github.com/dauparas/LigandMPNN) | Peptide Backbone (Peptide 3D Structure) | <img width="483" height="497" alt="CB1 Peptide" src="https://github.com/user-attachments/assets/03ca1daf-d626-4a13-bec8-04c815964e85" /> | Amino Acid Sequence | CYFVLWKC |
| [**AlphaFold**](https://github.com/google-deepmind/alphafold3) | Amino Acid Sequence | CYFVLWKC | Validated Structure Based on Worldwide Protein Structure Databases | <img width="854" height="746" alt="image" src="https://github.com/user-attachments/assets/e616da72-489b-49d6-b638-7b1c145fa9db" /> | 
