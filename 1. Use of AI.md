...
| Condition | GPCR Target | Desired Effect | Structure | RCSB ID |
|-----------|-------------|-------------|-------------|-------------|
| Bone Density Loss | Cannabinoid Receptor Type 1 | Excess CB1 signaling has been linked to increased bone resorption and reduced bone formation. | <img width="500" height="500" alt="image" src="https://github.com/user-attachments/assets/c40894be-53e2-49a7-afbc-856636348f19" /> | 5TGZ |
